...
export default function LeaderboardTable() {
  ...
  useEffect(() => {
    getRows('leaderboard', rowsPerPage * (page + 1), rowsPerPage * (page + 1) - rowsPerPage, sortConfig.key, sortConfig.direction).then((json) => {
      setRows(json.rows);
      
    });

    getPages('leaderboard', rowsPerPage).then((json) => {
